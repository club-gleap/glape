...
import { Box, Stack, Text, Flex, Image, VStack, Button, HStack, Center } from "@chakra-ui/react";
	...
	return (
		<Box h="100%" w="100%" minHeight={{base:"", md:"800px"}}>
			<Stack 
				...
				gap={"0"}
			>
				<Center h={{base:"", lg:"100%"}} w={{base:"100%", lg:"50%"}} p={{base:"12px", md:"16px", lg:"20px"}} justifyContent={"center"}>
