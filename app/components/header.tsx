...
export default function Header() {
  ...
  return (
    <>
      <Box as="header" position="fixed" top="0" left="0" right="0" zIndex="1000" display={{base:"none", md:"block"}} h="50px" bg="#812c99" color="white" borderTop="1px" borderColor="#812c99" px={{base:"10px", md:"20px"}} justifyContent="center">
